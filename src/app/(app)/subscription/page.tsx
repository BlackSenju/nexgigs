...
const GIGGER_TIERS = [
  {
    ...
    features: [
      ...
      { text: "Distance & Near Me sorting", built: true },
      { text: "XP rewards & badges", built: true },
    ],
  },
  {
    key: "pro",
    ...
    features: [
      ...
      { text: "AI Instant Match (5/day)", built: true },
      { text: "Earnings Goals Tracker", built: true },
      { text: "High Demand Alerts", built: true },
    ],
  },
  {
    key: "elite",
    ...
    features: [
      ...
      { text: "AI Job Matching (5/day)", built: true },
...
const BUSINESS_TIERS = [
  {
    ...
    features: [
      ...
      { text: "Applicant management dashboard", built: true },
      { text: "AI Instant Match", built: true },
    ],
  },
  {
    key: "business_growth",
